...
// De backend/src/routes/ -> ../../shared/types/index = backend/shared/types/index
import { N8nTransactionPayload, Transaction, TransactionStatus } from '../shared/types/index.js';
...
router.post('/create-transaction', async (req: Request, res: Response) => {
  try {
    const payload: N8nTransactionPayload = req.body;
    ...
    const transaction: Omit<Transaction, 'id'> = {
      ...
      type: payload.type,
      status: 'paid' as TransactionStatus, // Comprovantes geralmente são pagos
 ...
 */
router.post('/create-pending-confirmation', async (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/pending-confirmation/:from', async (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/confirm-transaction', async (req: Request, res: Response) => {
  try {
