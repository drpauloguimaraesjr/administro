...
export const BillingService = {
    ...
    async getByPatient(patientId, status) {
        let query = billingCollection
            .where('clinicId', '==', CLINIC_ID)
    ...
    async markMultipleAsPaid(ids, data) {
    ...
    // ====================================
    async createFromStockMovement(movementId, productId, productName, quantity, unitPrice, unitCost, patientId, patientName, prescriptionId, userId) {
        return this.create({
            patientId,
            patientName,
            productId,
